...
public class OrdersController : ControllerBase
{
    ...
    [Route("{orderId:int}")]
    [HttpGet]
    [ProducesResponseType(typeof(Ordering.Domain.AggregatesModel.Order), (int)HttpStatusCode.OK)]
    ...
    [Route("cardtypes")]
    [HttpGet]
    [ProducesResponseType(typeof(IEnumerable<Ordering.API.Application.Queries.CardType>), (int)HttpStatusCode.OK)]
    public async Task<ActionResult<IEnumerable<Ordering.API.Application.Queries.CardType>>> GetCardTypesAsync()
    {
